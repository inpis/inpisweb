            ...
            <div className="main-wrapper contact-page">
                ...
                <section className="contact-area">
                    <Container>
                        <Row>
                            <Col md="4">
                                <div className="contact-box-title" data-aos="fade-up">
                                    <h4>Get In Touch With Us</h4>
                                </div>
                                <div className="contact-icon-box d-flex" data-aos="fade-down">
                                    <div className="icon">
                                        <i className="las la-map-marker"></i>
                                    </div>
                                    <div className="box-content">
                                        <h5>Our Location</h5>
                                        <p>City Vista, Kolte-Patil Downtown, Kharadi, Pune, Maharashtra 411014</p>
                                    </div>
                                </div>
                                <div className="contact-icon-box d-flex" data-aos="fade-down">
                                    <div className="icon">
                                ...
                                <div className="contact-social">
                                    <ul className="social list-unstyled list-inline" data-aos="fade-down">
                            ...
                            <Col md="8">
                                <div className="contact-form">
                                    <div className="form-title" data-aos="fade-up">
                                        <h4>Get In Touch</h4>
                                    </div>
                                    <div className="form-box">
                                        <form id="form_contact" className="form" data-aos="fade-down">
                                            <Row>
                                                <Col md="6">
