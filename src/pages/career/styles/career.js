...
.card-time {
    ...
    background: url(../../assets/images/remote.png) no-repeat 0px 2px;
}
.card-briefcase {
    font-size: 12px;
    color: #A0ABB8;
    display: inline-block;
    padding: 0px 15px 0px 15px;
    background: url(../../assets/images/time.png) no-repeat 0px 2px;
}
.btn-grey-small {
...
.hover-up:hover {
    ...
    transition: all 0.25s cubic-bezier(0.05, 0.01, 0.47, 1);
}

.hover-up:hover .applyForm {
    transform: translateY(-3px);
    transition: all 0.25s cubic-bezier(0.05, 0.01, 0.47, 1);
}
.applyForm {
...
.applyForm {
    position: absolute;
    top: 0;
    background:rgba(20, 104, 156,0.7);
    width: 100%;
    height: 100%;
    display: flex;
